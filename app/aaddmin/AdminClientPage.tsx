...
export default function AdminClientPage({ initialCatalog }: AdminClientPageProps) {
  const [catalog, setCatalog] = useState<EditableCategory[]>(() => cloneCatalog(initialCatalog));
