      ...
      >
        ...
        <header className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-end sm:justify-between sm:text-left max-md:flex-none max-md:gap-3">
          <div>
            ...
            <h2 className="text-3xl font-semibold text-white sm:text-4xl max-md:text-2xl">Строительные материалы</h2>
          </div>
        ...
        {/* Сетка карточек */}
        <div className="mt-8 lg:mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:gap-5 max-md:mt-4 max-md:flex-1 max-md:grid-cols-1 max-md:grid-rows-12 max-md:gap-4">
