...
export default function CatalogPage() {
  ...
  return (
    <>
      ...
      />
      <section className="relative isolate overflow-hidden bg-gradient-to-br from-slate-950 via-teal-900 to-slate-950 px-4 pb-24 pt-8 text-white sm:px-6 lg:px-8">
