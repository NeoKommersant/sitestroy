...
const CONTACTS = [
  { role: "Руководитель проектов", phone: "+7 (495) 123-45-67" },
  { role: "Отдел снабжения", phone: "+7 (985) 222-33-44" },
  { role: "Отдел тендеров", phone: "+7 (916) 555-77-99" },
];
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-3 text-sm md:justify-end">
            ...
            <Link href="/press" className="text-blue-700 hover:text-blue-800">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            ...
            <div className="mt-3 space-y-1 text-xs text-slate-500">
              <div>Юр. адрес: 123022, г. Москва, ул. Строителей, д. 15</div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://t.me/stroyalliance" className="hover:text-blue-700">
                  Telegram
                </a>
              </li>
              <li>
                <a href="https://vk.com/stroyalliance" className="hover:text-blue-700">
                  ВКонтакте
                </a>
              </li>
              <li>
                <a href="https://rutube.ru/channel/stroyalliance" className="hover:text-blue-700">
                  RuTube
                </a>
              </li>
            </ul>
